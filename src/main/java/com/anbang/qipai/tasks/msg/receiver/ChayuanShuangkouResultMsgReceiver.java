...
import com.anbang.qipai.tasks.msg.channel.sink.ChayuanShuangkouResultSink;
...
public class ChayuanShuangkouResultMsgReceiver {
	...
	@StreamListener(ChayuanShuangkouResultSink.GAMECHAYUANSKRESULT)
	public void recordChayuanShuangkouHistoricalResult(CommonMO mo) {
